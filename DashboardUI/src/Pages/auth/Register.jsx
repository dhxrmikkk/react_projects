    ...
    const handleRegister = (e) => {
        ...
        if (email === '') {
            ...
            try {
                ...
                setTimeout(() => {
                    localStorage.setItem("userdata", JSON.stringify(registeredUserDetail)); // Corrected line
            ...
            <section className='h-screen p-6 flex w-full font-geist'>
                ...
                <div className='md:w-2/3 w-full p-6 flex flex-col justify-center'>
                    ...
                    <div className='mb-16'>
                        ...
                        <h4 className='md:text-lg text-sm'>Enter Your Credentials To Create Account.</h4>
                    </div>
                    ...
                    <form onSubmit={handleRegister} className='mb-16 max-w-[40rem]'>
                        ...
                        <div className='mt-16'>
                            <Button
                                type='submit'
                                className='w-full p-3 tracking-wider text-[14px] font-normal font-geist'>
                                Register
                            </Button>
                        </div>
                    </form>
