                            ...
                            <div className='w-full h-full grid lg:grid-cols-2 gap-5'>
                                ...
                                <div className='flex items-center w-full h-full'>
                                    <div className='flex flex-col'>
                                        <div>
                                            <span className='capitalize md:text-lg text-sm tracking-wider font-[500] text-[#646467]'>{product.category}</span>
                                        </div>
                                        <div className='my-5'>
                                        ...
                                        <div className='my-8 flex flex-col items-center lg:items-start space-y-8'>
                                            ...
                                            <button
                                                type='submit'
                                                onClick={() => addToCartProduct(product.id, product.price, quantity, product)}
                                                className='uppercase lg:py-3.5 py-2.5 px-6 border border-pink-500 text-pink-500 font-semibold hover:bg-pink-500 hover:text-white transition-colors duration-300 ease-in-out w-full sm:w-auto'>
                                                Add to cart
                                            </button>
                                        </div>
                                    </div>
